 ...
 */
 ...
 {
  public static final class ElevadorC
  {
    //23
    //24
    public static int motor1ID = 23;
    public static int motor2ID = 24;
    public static int motorCurrentLimit = 40;
  ...
  {
    public static final int k_Canrager1 = 18;
    public static final int k_Canrager2 = 19;

    public static final int k_TracaoID = 22;

    public static final int k_ShooterID = 21;
    public static final int SO_kCurrentLimit = 70;
    public static final int SO_kCurrentThreshold = 120;
    public static final double SO_kCurrentThresholdTime = 0.1;
    public static final boolean SO_kEnableCurrentLimit = true;
    public static final double SO_kClosedLoopRamp = 0.25;
    public static boolean SO_kInverted = true;
